...
public class MyUploadService extends MyBaseTaskService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_UPLOAD.equals(intent.getAction())) {
            ...
            uploadFromUri(fileUri, chatroom);
        }
    ...
    private void uploadFromUri(final Uri fileUri, final String chatroom) {
        ...
        final StorageReference photoRef = mStorageRef.child(chatroom)
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        boolean success = downloadUrl != null;
        String caption = success ? "Upload Success" : "Upload Failure";
